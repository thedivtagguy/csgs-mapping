	  ...
	  <div class="md:col-span-1">
		<div class="px-4 sm:px-0">
		  ...
		  <p class="mt-1 text-sm text-gray-600">
			Please enter the details of the resource below. Our team will go through the submission, and if it meets our criteria, we’ll add it to the database.
		  </p>
		</div>
	  </div>
	  <div class="mt-5 md:mt-0 md:col-span-2">
		<form id="myform" on:submit{handleSubmit} name="submission" method="POST" data-netlify="true">
		  <div class="overflow-hidden sm:rounded-none">
			<div class="px-4 py-5  sm:p-6">
			  <div class="flex flex-col gap-6">
				...
				<div class="col-span-6 sm:col-span-3 lg:col-span-2">
					...
					<input type="text" name="resource_contact" id="resource_contact" autocomplete="postal-code" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full  sm:text-sm border-gray-300 rounded-xs">
				  </div>
				...
				<div>
					...
					<select required id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
				...
				<div>
					...
					<textarea id="comments" name="comments" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
