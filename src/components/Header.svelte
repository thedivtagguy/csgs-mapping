  ...
  <div class="py-12 ">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <p class="mt-2 text-3xl leading-8 w-1/2 mx-auto font-extrabold tracking-tight text-gray-900 sm:text-4xl">A faff-free guidebook on preparing for your design internship</p>
        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">Stuff we learnt so you can do better</p>
      </div>
